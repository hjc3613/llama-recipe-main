...
class QWenLMHeadModelDPO(QWenLMHeadModel):
    def __init__(self, config):
        super().__init__(config)
    ...
    def forward(
        self,
        concatenated_input_ids: torch.LongTensor = None,
        concatenated_attention_mask: torch.FloatTensor = None,
        concatenated_labels: torch.LongTensor = None,
