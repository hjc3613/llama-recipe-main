...
data_root=/fl-ift/med/hujunchao/git_root/llama-recipes-main/data/yingxiang_report/生成所见
file_name=train_abnormal_to_template_2部分数据错误纠正240505allasrnew_prompt1.xlsx
