...
model_name='/fl-ift/med/common/Qwen2.5-72B-Instruct'
# model_name='/fl-ift/med/common/Qwen-14B-Base'
# model_name='/fl-ift/med/hujunchao/models/unigpt_pro_17B'
# model_name='/fl-ift/med/hujunchao/models/mixed_task_radiology-unigpt_pro_17B-stepfinal'
...
if [[ $MODE == *"train"* ]]; then 
    ...
    --freeze_strategy 'freeze:1-40-1' `# action:9-90-9, freeze:[0,2,4,6-10]` \
    --parallel_granularity 'weight' `# weight、decoder_layer、QWenAttention-QWenMLP-RMSNorm、QWen2SdpaAttention-QWen2FlashAttention2-QWen2Attention-QWen2MLP-QWen2RMSNorm` \
    # --fsdp_cpu_offload \
    # --max_train_step 100 \
    # --gamma 0.6 \
