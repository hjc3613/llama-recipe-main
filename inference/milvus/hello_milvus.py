...
def embed_with_str(text):
    resp = dashscope.TextEmbedding.call(
        ...
        api_key='sk-39204ca0f48f4279a80846112795ed63',  # 如果您没有配置环境变量，请将您的APIKEY填写在这里
        input=text)
...
client = MilvusClient(uri="http://10.1.0.27:2379") # Replace with your Milvus server address
